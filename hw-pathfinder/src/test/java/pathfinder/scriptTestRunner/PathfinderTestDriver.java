...
public class PathfinderTestDriver {
    ...
    private void addEdge(String graphName, String parentName, String childName,
                         String edgeLabel) {
        double parsedLabel = Double.parseDouble(edgeLabel);
        ...
        DirectedLabeledGraph.Edge<String,Double> e = new DirectedLabeledGraph.Edge<>(parsedLabel,
                                                        parent,child);
        dlg.addEdge(e);
        output.println("added edge " + String.format("%.3f",parsedLabel) + " from " + parentName + " to " + childName
                + " in " + graphName);
    }
    ...
    private void listChildren(String graphName, String parentName) {
        ...
        for(DirectedLabeledGraph.Edge<String,Double> edge : edges) {
